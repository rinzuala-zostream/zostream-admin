<template>
  <div class="max-w-10xl px-4 sm:px-6 lg:px-8 py-8">
    <div
      ...
      <!-- Form Header -->
      <div
        class="bg-gradient-to-r from-purple-500 to-indigo-600 dark:from-purple-600 dark:to-indigo-700 px-6 py-4 sm:px-8">
        ...
        <form @submit.prevent="submitForm" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-2">
                ...
                <div v-if="form.cover_img" class="mt-2">
                  <div class="text-xs text-gray-500 dark:text-gray-400">Preview:</div>
                  <img :src="form.cover_img" alt="Cover preview"
                    class="mt-1 h-20 w-auto rounded border border-gray-200 dark:border-gray-700 object-cover">
                </div>
              </div>
          ...
          'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-800': message.startsWith('Failed')
            ...
            <svg v-if="!message.startsWith('Failed')"
              class="h-5 w-5 mr-2 text-green-500 dark:text-green-400 flex-shrink-0" fill="none" stroke="currentColor"
