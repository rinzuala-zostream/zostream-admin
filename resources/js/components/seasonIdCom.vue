        ...
        <form @submit.prevent="handleFormSubmit" class="p-6 sm:p-8">
          ...
          <div class="mb-8">
            <div class="flex items-center mb-4">
              ...
              <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">Season</h2>
            </div>
            <div>
          ...
          <div class="mb-8">
            ...
            <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-700/50">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
              <label for="episodeId" class="sr-only">ID</label>
              <input
                id="episodeId"
                type="text"
              ...
              <div>
              <label for="episodeTxt" class="sr-only">Txt</label>
              <input
                id="episodeTxt"
                type="text"
...
// --- NEW ---
/**
 * Resets all form fields and related state to their initial values.
 */
const resetForm = () => {
  // Reset reactive objects
  Object.assign(movie, { id: '', title: '', img: '' });
  Object.assign(season, { name: '', episode: { id: '', txt: '' } });
